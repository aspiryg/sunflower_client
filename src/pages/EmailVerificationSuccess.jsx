  ...
  &::before {
    ...
    background: ${(props) =>
      props.$variant === "success"
        ? "linear-gradient(90deg, var(--color-success-500) 0%, var(--color-success-600) 100%)"
        : "linear-gradient(90deg, var(--color-error-500) 0%, var(--color-error-600) 100%)"};
...
function EmailVerificationSuccess() {
  ...
  // Get status and reason from URL parameters
  ...
  const getErrorMessage = () => {
    switch (reason) {
      ...
      default:
        return "We couldn't verify your email address at this time.";
    }
  };
